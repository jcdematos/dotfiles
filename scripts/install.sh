...
then
	...
	sudo dnf install i3-gaps i3blocks git neovim mpv emacs zathura alacritty python3  python3-pip  task picom newsboat firefox krita jq dmenu tmux feh syncthing fontawesome5-fonts adb scrcpy ripgrep khal fd-find -y
fi
